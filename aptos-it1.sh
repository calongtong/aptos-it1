...
apt update && apt install git sudo unzip wget net-tools htop -y
#install docker
...
wget -O fullnode.yaml https://raw.githubusercontent.com/calongtong/aptos-it1/main/fullnode.yaml
